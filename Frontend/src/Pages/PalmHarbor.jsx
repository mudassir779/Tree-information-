          ...
          <div className="lg:w-2/3">
            ...
            <div className="mt-12">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Tree Trimming & Pruning in Palm Harbor, FL</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Structural Pruning in Palm Harbor, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Tree Removal in Palm Harbor, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Land Clearing in Palm Harbor, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Storm Clean Up in Palm Harbor, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Deep Root Fertilization in Palm Harbor, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Commercial Tree Services in Palm Harbor, FL</h3>
                  <p className="text-gray-600">
              ...
              <div className="mt-10 bg-blue-50">
                ...
                <p className="text-gray-600 ">We understand that your trees are a valuable investment and pride ourselves in providing reliable and cost-effective services. Don’t hesitate to contact us at
                  {" "}
