...
const Dunedin = () => {
  ...
  const images = [
    { src: "/23.jpg", alt: "Tree service example" },
    { src: "/24.jpg", alt: "Tree trimming example" }
  ];
    ...
    <div className="">
      ...
      <div className="mt-12 mx-4 sm:mx-8 lg:mx-20 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3">
          ...
          <p className="mb-8">
            Ken's Tree Service has been providing quality tree care services to the Dunedin, FL area for over 22 years. Our team of experts are members of the International Society of Arboriculture and Tree Care Industry Association, so you can trust that your trees will receive excellent care. We offer a range of services, such as: 
          </p>
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-2">
              Tree Services in Dunedin, FL
            </h2>

            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Tree Trimming & Pruning</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Structural Pruning</h3>
                <p className="text-gray-600">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Tree Removal</h3>
                <p className="text-gray-600">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Land Clearing</h3>
                <p className="text-gray-600">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Storm Clean Up</h3>
                <p className="text-gray-600">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Deep Root Fertilization</h3>
                <p className="text-gray-600">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Commercial Tree Services</h3>
                <p className="text-gray-600">
            ...
            <div className="mt-10 bg-blue-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4 text-gray-800">Trust Ken's Tree Service for Professional Tree Care Services in Dunedin, FL</h3>
              <p className="text-gray-600 mb-4">
                At Ken's Tree Service, our professional arborists have been providing top-notch services in Dunedin, FL for over two decades. With unmatched expertise and a passion for delivering outstanding results every single time, we are the team to call when you require quality tree care services.
              </p>
              <p className="text-gray-600">
                We understand that your trees are a valuable investment and pride ourselves in providing reliable and cost-effective services. Don't hesitate to contact us at (727) 934-5804 to learn more about how we can help keep your property looking its best.
              </p>
            </div>
        ...
        <div className="lg:w-1/3">
          <div className="bg-white p-6 rounded-lg shadow-md sticky top-4">
            ...
            <div className="mt-8 bg-blue-50 p-4 rounded-lg">
              <h4 className="font-bold text-gray-800 mb-2">24/7 Emergency Service</h4>
              <p className="text-gray-600 mb-3">Available for storm damage and hazardous tree removal</p>
              <a 
                href="tel:7279345804" 
                className="block w-full text-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors flex items-center justify-center"
              >
                <FaPhone className="mr-2" /> (727) 934-5804
              </a>
            </div>
          </div>
        </div>
