...
const Oldsmar = () => {
  ...
  const images = [
    { src: "/Tree-Removal-Oldsmar-FL-400x284.jpg", alt: "Tree Removal Oldsmar FL", title: "Tree Services, Oldsmar, FL 1" },
    { src: "/Tree-Services-Oldsmar-FL-400x284.png", alt: "Tree Services Oldsmar FL", title: "Tree Services, Oldsmar, FL 2" }
  ];
        ...
        <div className="mt-12 mx-4 sm:mx-8 lg:mx-20 flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            <h1 className="text-2xl font-extrabold text-gray-800 mb-6">
              Your Top Choice for Tree Service in Oldsmar, FL
            </h1>
            ...
            <p className="mb-8">
              Ken's Tree Service has been providing quality tree care services to the Oldsmar, FL area for over 22 years. Our team of experts are members of the International Society of Arboriculture and Tree Care Industry Association, so you can trust that your trees will receive excellent care. We offer a range of services, such as:
            </p>
            ...
            <div className="mt-12">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Tree Trimming & Pruning in Oldsmar, FL</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Structural Pruning in Oldsmar, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Tree Removal in Oldsmar, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Land Clearing in Oldsmar, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Storm Clean Up in Oldsmar, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Deep Root Fertilization in Oldsmar, FL</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-gray-800">Commercial Tree Services in Oldsmar, FL</h3>
                  <p className="text-gray-600">
              ...
              <div className="mt-10 bg-blue-50">
                ...
                <p className="text-gray-600 mb-4">We understand that your trees are a valuable investment and pride ourselves in providing reliable and cost-effective services. Don’t hesitate to contact us at
                  {" "}
                  <a href="tel:812-213-5997" className="text-[#245b3c]">
                    (812) 213-5997
                  </a>
                  {" "}
                  to learn more about how we can help keep your property looking its best.</p>
              </div>

              <div className="w-full h-96 mt-8 mb-10 overflow-hidden shadow-lg">
                <iframe
                  className="w-full h-full"
                  src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d112678.29343970992!2d-82.679357!3d28.049019!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88c2eba4bc348a95%3A0x807a11ffb3e6b835!2sOldsmar%2C%20FL!5e0!3m2!1sen!2sus!4v1753732166108!5m2!1sen!2sus"
                  allowFullScreen=""
                  loading="lazy"
