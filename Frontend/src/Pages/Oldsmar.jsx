            ...
            <div className="lg:w-2/3">
              ...
              <div className="mt-8 sm:mt-12">
                ...
                <div className="space-y-6 sm:space-y-8">
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Tree Trimming & Pruning in Oldsmar, FL</h3>
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Structural Pruning in Oldsmar, FL</h3>
                    <p className="text-gray-600 text-sm sm:text-base">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Tree Removal in Oldsmar, FL</h3>
                    <p className="text-gray-600 text-sm sm:text-base">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Land Clearing in Oldsmar, FL</h3>
                    <p className="text-gray-600 text-sm sm:text-base">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Storm Clean Up in Oldsmar, FL</h3>
                    <p className="text-gray-600 text-sm sm:text-base">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Deep Root Fertilization in Oldsmar, FL</h3>
                    <p className="text-gray-600 text-sm sm:text-base">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800">Commercial Tree Services in Oldsmar, FL</h3>
                    <p className="text-gray-600 text-sm sm:text-base">
                ...
                <div className="mt-8 sm:mt-10 bg-blue-50 p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-gray-800">Trust Ken's Tree Service for Professional Tree Care Services in Oldsmar, FL</h3>
