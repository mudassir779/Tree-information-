          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
            ...
            <div className="lg:w-2/3">
              ...
              <p className="mb-6 sm:mb-8 text-sm sm:text-base">
                American Tree Experts Land has been providing quality tree care services to the Newburgh, IN area for over 22 years. Our team of experts are members of the International Society of Arboriculture and Tree Care Industry Association, so you can trust that your trees will receive excellent care.
              </p>
              ...
              <div className="mt-8 sm:mt-12">
                ...
                <div className="mt-8 sm:mt-10 bg-blue-50 p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-gray-800">Trust American Tree Experts Land</h3>
                  <p className="text-gray-600 mb-3 sm:mb-4 text-sm sm:text-base">
                    At American Tree Experts Land, our professional arborists have been providing top-notch services in Newburgh, IN for over two decades. With unmatched expertise and a passion for delivering outstanding results every single time, we are the team to call when you require quality tree care services. 
                  </p>
                  <p className="text-gray-600 text-sm sm:text-base">
                ...
                <div className="w-full h-64 sm:h-80 md:h-96 mt-6 sm:mt-8 overflow-hidden shadow-lg">
                  <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d25167.748476032022!2d-87.40710254901413!3d37.9545200931904!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x886e2d2d562ea489%3A0x5f7e4f1c3504a6d8!2sNewburgh%2C%20IN%2047630!5e0!3m2!1sen!2sus!4v1753881305962!5m2!1sen!2sus"
                    allowFullScreen=""
                    loading="lazy"
                    referrerPolicy="no-referrer-when-downgrade"
                    title="NewBurgh Location Map"
                  ></iframe>
                </div>
              </div>
            </div>
