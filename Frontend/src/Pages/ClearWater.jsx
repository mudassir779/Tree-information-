...
const ClearWater = () => {
  ...
  const images = [
    { src: "/22.jpg", alt: "Tree service example" },
    { src: "/5.jpg", alt: "Tree trimming example" }
  ];
    ...
    <div className="">
      ...
      <div className="mt-12 mx-4 sm:mx-8 lg:mx-20 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3">
          ...
          {/* Image Gallery */}
          <div className="flex gap-4 md:gap-8 mt-2 mb-12">
          ...
          <div className="mt-12">
            ...
            <div className="mt-10 bg-blue-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4 text-gray-800">Why Choose Ken's Tree Service?</h3>
