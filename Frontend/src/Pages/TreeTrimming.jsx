    ...
    <div className="w-full">
      ...
      <div className="w-10/12 mx-auto pt-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            ...
            <div className="flex flex-col md:flex-row gap-15 mb-12">
              <div className="bg-[#245b3c] mb-10 mr-10 p-15 flex-1 justify-center items-center">
      ...
      <div className="w-full bg-gradient-to-b from-[#f8faec] to-[#bcc49b] py-20 mt-10">
        <div className="w-10/12 mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-[#245B3C] text-lg font-bold uppercase">Why it Helps</p>
          ...
          <p className="text-center max-w-full mx-auto text-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5 mt-10 pb-10">
            <div className="h-full bg-white border-2 border-[#B0B694] p-10 hover:shadow-xl transition-shadow duration-300">
              <img
                src="/safety.PNG"
                alt="Safety icon"
      ...
      <div className="w-10/12 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-20 mt-16 mb-16">
          <div className="relative lg:w-5/12 group shadow-lg shadow-black">
            ...
            <img loading="lazy" decoding="async" src="/25488113_844434852383648_5012362303994108244_o.jpg" alt="contact us" title="25488113_844434852383648_5012362303994108244_o" className="relative w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500 z-10" />
          </div>
          <div className="lg:w-11/12">
            ...
            <ul className="list-disc pl-10 space-y-2 text-gray-700">
              <li className="hover:text-green-700 hover:cursor-pointer transition-colors duration-200">
