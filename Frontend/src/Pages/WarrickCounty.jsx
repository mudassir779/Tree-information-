    ...
    <div className="overflow-x-hidden">
      ...
      {lightboxOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center p-4">
          ...
          <div className={`max-w-4xl w-full ${isMobile ? 'mx-2' : 'mx-16'}`}>
            <img
      ...
      <div className="w-full md:w-11/12 lg:w-10/12 mx-auto mb-12 md:mb-20 px-4 sm:px-6">
        {/* Main Content */}
        <div className="mt-8 md:mt-12 mx-2 sm:mx-4 lg:mx-8 xl:mx-20 flex flex-col lg:flex-row gap-6 md:gap-8">
          ...
          <div className="lg:w-2/3">
            ...
            {/* Image Gallery */}
            <div className={`relative flex ${isMobile ? 'flex-col gap-4' : 'flex-row gap-4 md:gap-8'} mt-2 mb-8 md:mb-12`}>
              {images.map((image, index) => (
                <div
                  key={index}
                  className={`${isMobile ? 'w-full' : 'flex-1'} relative group cursor-pointer`}
                ...
                >
                  <img
                    ...
                    alt={image.alt}
                    title={image.title}
                    className="w-full h-48 sm:h-56 md:h-64 lg:h-80 object-cover border-4 border-black shadow-lg md:shadow-xl shadow-[#333] group-hover:opacity-80 transition-opacity"
                  />
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <div className="bg-[#afb236] bg-opacity-50 rounded-full p-2 md:p-3">
            ...
            <div className="mt-8 md:mt-12">
              ...
              <div className="space-y-6 md:space-y-8">
                {[
                  ...
                  <div key={index}>
                    <h3 className="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-gray-800">{service.title}</h3>
          ...
          {/* Right Side - Sidebar */}
          <div className="lg:w-1/3 pt-6 md:pt-8 lg:pt-10 space-y-4 md:space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              <h3 className="text-sm md:text-md flex items-center font-bold bg-[#1e4d32] w-full text-white mb-2 md:mb-4 px-4 py-2 md:px-5 md:py-2">
              ...
              <ul className="space-y-1 md:space-y-2 p-2 md:p-3">
                {services.map((service, index) => (
                  <li key={index}>
                    <a
                      href={service.path}
                      className={`block px-2 py-1 md:px-3 md:py-2 rounded transition text-sm md:text-base ${
