    ...
    <div className="w-full">
          ...
          <div className="lg:w-2/3">
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-8">
              <div className="md:w-1/2">
                ...
                <ul className="text-md list-inside list-disc pl-6 text-gray-700">
              ...
              <div className="md:w-1/2 group overflow-hidden">
                <img
                  ...
                  className="w-3/5 h-auto shadow-md transform group-hover:scale-105 transition-transform duration-500"
                />
              </div>
            </div>
      ...
      <div className="w-full bg-gradient-to-b from-[#f8faec] to-[#bcc49b] py-20 mt-10">
        <div className="w-10/12 mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-[#245B3C] text-lg font-bold uppercase">24/7 Availability</p>
